...
```
(see apsimx_path element of the list  params in te document header at the beginning of the .Rmd file).
If you want to change the value of this parameter you may use Knit, then *"Knit with parameters"*.
